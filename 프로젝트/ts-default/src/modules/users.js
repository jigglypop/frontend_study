...
const getUsersPending = createAction(GET_USERS_PENDING);
const getUsersSuccess = createAction(GET_USERS_SUCCESS, (payload) => payload);
const getUsersFailure = createAction(GET_USERS_FAILURE, (payload) => payload);
